...
class PROTOBUF_EXPORT Timestamp final :
    public ::google::protobuf_inworld::Message /* @@protoc_insertion_point(class_definition:google.protobuf.Timestamp) */ {
 public:
  inline Timestamp() : Timestamp(nullptr) {}
  ~Timestamp() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Timestamp(::google::protobuf_inworld::internal::ConstantInitialized);

  Timestamp(::google::protobuf_inworld::Arena* arena, const Timestamp& from);
  ...
  Timestamp* New(::google::protobuf_inworld::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit Timestamp(::google::protobuf_inworld::Arena* arena);
  public:
