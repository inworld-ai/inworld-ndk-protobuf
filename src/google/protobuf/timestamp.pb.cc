...
const ::uint32_t TableStruct_google_2fprotobuf_2ftimestamp_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::google::protobuf_inworld::Timestamp, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::google::protobuf_inworld::Timestamp, _impl_.seconds_),
    PROTOBUF_FIELD_OFFSET(::google::protobuf_inworld::Timestamp, _impl_.nanos_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::google::protobuf_inworld::Timestamp)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::google::protobuf_inworld::_Timestamp_default_instance_._instance,
};
...
Timestamp::Timestamp(::google::protobuf_inworld::Arena* arena)
    : ::google::protobuf_inworld::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:google.protobuf.Timestamp)
}
Timestamp::Timestamp(
    ::google::protobuf_inworld::Arena* arena, const Timestamp& from)
    : Timestamp(arena) {
  MergeFrom(from);
}
...
const ::google::protobuf_inworld::Message::ClassData Timestamp::_class_data_ = {
    Timestamp::MergeImpl,
};
const ::google::protobuf_inworld::Message::ClassData* Timestamp::GetClassData() const {
  return &_class_data_;
}

void Timestamp::MergeImpl(::google::protobuf_inworld::Message& to_msg, const ::google::protobuf_inworld::Message& from_msg) {
...
::google::protobuf_inworld::Metadata Timestamp::GetMetadata() const {
