...
class PROTOBUF_EXPORT Any final :
    public ::google::protobuf_inworld::Message /* @@protoc_insertion_point(class_definition:google.protobuf.Any) */ {
 public:
  inline Any() : Any(nullptr) {}
  ~Any() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR Any(::google::protobuf_inworld::internal::ConstantInitialized);

  Any(::google::protobuf_inworld::Arena* arena, const Any& from);
  ...
  bool PackFrom(const ::google::protobuf_inworld::Message& message) {
  ...
  bool UnpackTo(::google::protobuf_inworld::Message* message) const {
  ...
  template <typename T, class = typename std::enable_if<!std::is_convertible<T, const ::google::protobuf_inworld::Message&>::value>::type>
  ...
  Any* New(::google::protobuf_inworld::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit Any(::google::protobuf_inworld::Arena* arena);
  public:
 ...
 private:
  ...
  struct PROTOBUF_EXPORT Impl_ {
    ...
    ::google::protobuf_inworld::internal::AnyMetadata _any_metadata_;
