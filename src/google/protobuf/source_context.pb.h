...
class PROTOBUF_EXPORT SourceContext final :
    public ::google::protobuf_inworld::Message /* @@protoc_insertion_point(class_definition:google.protobuf.SourceContext) */ {
 public:
  inline SourceContext() : SourceContext(nullptr) {}
  ~SourceContext() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR SourceContext(::google::protobuf_inworld::internal::ConstantInitialized);

  SourceContext(::google::protobuf_inworld::Arena* arena, const SourceContext& from);
  ...
  SourceContext* New(::google::protobuf_inworld::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit SourceContext(::google::protobuf_inworld::Arena* arena);
  public:
 ...
 private:
  ...
  struct PROTOBUF_EXPORT Impl_ {
    ...
    ::google::protobuf_inworld::internal::ArenaStringPtr file_name_;
