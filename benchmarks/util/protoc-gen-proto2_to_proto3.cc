...
using google::protobuf_inworld::util::ExtensionStripper;
using google::protobuf_inworld::util::FieldScrubber;
...
int main(int argc, char* argv[]) {
  google::protobuf_inworld::compiler::Proto2ToProto3Generator generator;
